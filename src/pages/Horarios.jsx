    ...
    return (
        <div className="container contenedor px-5">
            ...
            {/* <div className="row">
                ...
                <div className="col-md-4">
                    <a href='https://docs.google.com/spreadsheets/d/1Xd3OOQxeUJFRraxwiu_vkVBDycjZpICS3ttpl1k0kkU/edit?gid=0#gid=0' target="_blank" rel="noopener noreferrer" className='link-underlinelink-offset-2 link-underline link-underline-opacity-0'>
                        <Card border="primary" className="mb-4 btnCard">
